...
FUNDO_MENU = pygame.transform.scale(FUNDO_MENU, (SCREEN_WIDTH, SCREEN_HEIGHT))
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_RETURN and input_letra:
                        if input_letra.lower() == "hogwarts":
                             print("easter egg ativado! 10 pontos para a curiosidade ")
                             input_letra = ""
                             continue
